...
class ThreedotView: UIView {
    ...
    */
    ...
    @IBOutlet weak var editTextButton
        : UIButton!
    
    @IBOutlet weak var deleteButton: UIButton!
    @IBOutlet weak var reportAsSpamButton: UIButton!
    ...
    override init(frame: CGRect)
     ...
     func loadviewfromNib() ->UIView
     {
             ...
             let nib = UINib(nibName: "threedotModal",bundle: bundle)
